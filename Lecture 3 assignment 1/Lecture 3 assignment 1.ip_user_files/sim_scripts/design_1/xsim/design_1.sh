...
#
# Generated by Vivado on Fri Feb 21 13:36:54 +0100 2025
...
xv_boost_lib_path=C:/Xilinx_editions/Vivado/2019.1/tps/boost_1_64_0
xvhdl_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="C:/Xilinx_editions/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
