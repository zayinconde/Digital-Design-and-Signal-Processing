...
{
	iki_sensitize(dp, "xsim.dir/tb_SR_flipflop_time_impl/xsim.reloc");
}

void simulate(char *dp)
{
		iki_schedule_processes_at_time_zero(dp, "xsim.dir/tb_SR_flipflop_time_impl/xsim.reloc");
	// Initialize Verilog nets in mixed simulation, for the cases when the value at time 0 should be propagated from the mixed language Vhdl net

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 30264, dp + 30992, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 30208, dp + 31384, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 30152, dp + 31496, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 30320, dp + 30936, 0, 0, 0, 0, 1, 1);
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/tb_SR_flipflop_time_impl/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/tb_SR_flipflop_time_impl/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/tb_SR_flipflop_time_impl/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, 0, isimBridge_getWdbWriter(), 0, argc, argv);
