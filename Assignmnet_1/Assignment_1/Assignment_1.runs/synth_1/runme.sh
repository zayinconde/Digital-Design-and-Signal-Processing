...
HD_PWD='D:/Design_DSP/Assignmnet_1/Assignment_1/Assignment_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EightBitAlu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EightBitAlu.tcl
