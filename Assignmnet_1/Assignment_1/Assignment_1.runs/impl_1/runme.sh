...
HD_PWD='D:/Design_DSP/Assignmnet_1/Assignment_1/Assignment_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EightBitAlu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EightBitAlu.tcl -notrace
