...
HD_PWD='D:/Design_DSP/Assignmnet_2/Assigment_2/Assigment_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CounterEightBit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CounterEightBit.tcl
