...
HD_PWD='D:/Design_DSP/Assignmnet_2/Assigment_2/Assigment_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CounterEightBit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CounterEightBit.tcl -notrace
